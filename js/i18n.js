...
window.I18N = (() => {
  ...
  const en = {
    ...
    "home.uploadProof": "Upload your payment photo",
    "home.uploadProofText": "Already paid? Upload your payment photo yourself — right from your phone, no WhatsApp needed.",
    "home.justin": "Just in",
    ...
    "ck.payCountryNote": "Benin and Togo customers: pay in F CFA via MTN MoMo (Benin) or Moov Money (Togo) using the details below. Minimum order is 5,000 CFA (₦12,000).",
    "ck.minOrderCfa": "Benin deliveries: minimum order 5,000 F CFA. Please add a few more items to meet the minimum.",
    "ck.minOrderNgn": "Benin deliveries: minimum order 12,000 naira. Please add a few more items to meet the minimum.",
    ...
    "ck.payNotConfigured": "Payment details are being updated. Please contact us on WhatsApp to complete your payment.",
    ...
    "faq.a6": "Message us on WhatsApp with your order ID (for example JA-M8K2Q1) and we will tell you if it is waiting, confirmed, or declined.",
  ...
  const fr = {
    ...
    "conv.banner": "Clients du Bénin 🇧🇯 : passez commande maintenant et recevez-la entre le {from} et le {to}",
    ...
    "home.uploadProof": "Envoyer votre photo de paiement",
    "home.uploadProofText": "Déjà payé ? Envoyez vous-même la photo de votre paiement — depuis votre téléphone, sans passer par WhatsApp.",
    ...
    "promo.referral": "Commandez plus de 20 000 ₦ (8 800 CFA) et recevez votre code de parrainage personnel — partagez-le et vos amis bénéficient d'une réduction au paiement.",
    "promo.shop": "Acheter",
    ...
    "ck.minOrderCfa": "Livraisons au Bénin : commande minimum de 5 000 F CFA. Ajoutez quelques articles de plus pour atteindre le minimum.",
    "ck.minOrderNgn": "Livraisons au Bénin : commande minimum de 12 000 nairas. Ajoutez quelques articles de plus pour atteindre le minimum.",
    ...
    "ck.payNotConfigured": "Nos coordonnées de paiement sont en cours de mise à jour. Contactez-nous sur WhatsApp pour finaliser votre paiement.",
