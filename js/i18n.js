...
window.I18N = (() => {
  ...
  const en = {
    ...
    "ck.bjMin": "Benin deliveries: minimum order 3,000 F CFA (about 6,800 naira).",
    "ck.minOrderCfa": "Benin deliveries: minimum order 3,000 F CFA. Please add a few more items to meet the minimum.",
    "ck.minOrderNgn": "Benin deliveries: minimum order 6,800 naira. Please add a few more items to meet the minimum.",
  ...
  const fr = {
    ...
    "ck.bjMin": "Livraisons au Bénin : commande minimum de 3 000 F CFA (environ 6 800 nairas).",
    "ck.minOrderCfa": "Livraisons au Bénin : commande minimum de 3 000 F CFA. Ajoutez quelques articles de plus pour atteindre le minimum.",
    "ck.minOrderNgn": "Livraisons au Bénin : commande minimum de 6 800 nairas. Ajoutez quelques articles de plus pour atteindre le minimum.",
