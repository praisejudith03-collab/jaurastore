...
window.I18N = (() => {
  ...
  const fr = {
    ...
    "promo.referral": "Commandez plus de 20 000 ₦ (environ 8 800 F CFA) et recevez votre code de parrainage personnel — partagez-le et vos amis bénéficient d'une réduction au paiement.",
    "promo.shop": "Acheter",
    ...
    "ck.bjMin": "Livraisons au Bénin : commande minimum de 5 000 F CFA (environ 11 400 nairas).",
    ...
    "ck.minOrderNgn": "Livraisons au Bénin : commande minimum de 11 400 nairas. Ajoutez quelques articles de plus pour atteindre le minimum.",
