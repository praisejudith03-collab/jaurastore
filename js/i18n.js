...
window.I18N = (() => {
  ...
  const en = {
    ...
    "ck.payIntro": "Make your payment directly into our bank account first on the details below. Please upload the bank payment receipt and use your Order ID as the payment reference. Your transport fare will be discussed with you on WhatsApp. Your receipt is saved in the admin portal. JauraStore will confirm your payment.",
    ...
    "ck.emailNote": "Your receipt is saved in the admin portal. JauraStore will confirm your payment.",
    "ck.uploadReceipt": "Upload the bank payment receipt",
    "ck.legal": "Your personal data is used to process your order. Upload your payment receipt here. JauraStore will confirm your payment, and your receipt is saved in the admin portal. Transport fare is discussed on WhatsApp.",
    ...
    "ck.saveId": "Save this order ID. JauraStore will confirm your payment. Your receipt is saved in the admin portal. Your transport fare will be discussed on WhatsApp.",
    ...
    "order.waitMsg": "Upload your payment receipt here or send it on WhatsApp. JauraStore will confirm your payment, and your receipt is saved in the admin portal.",
    "pay.kicker": "Payment",
    "pay.title": "Send your payment screenshot",
    "pay.lead": "Upload the receipt or screenshot from your bank or MoMo. It is saved in the admin portal, then we confirm your payment.",
    "pay.id": "Order ID *",
    ...
    "contact.lead": "Our team is ready to assist you for a smooth shopping experience. Complete checkout, send payment in CFA or Naira, then send your payment screenshot to us on WhatsApp. Your receipt is saved in the admin portal. JauraStore will confirm your payment.",
    "contact.phone": "Phone",
    "contact.email": "Email",
    ...
    "faq.a1": "01 Select your items. 02 Review your bag. 03 Complete checkout. 04 Send payment in F CFA or ₦. 05 Upload your payment receipt on checkout. 06 JauraStore will confirm your payment and your receipt is saved in the admin portal. Transport fare is discussed on WhatsApp.",
    ...
    "faq.a5": "Pay by bank transfer in F CFA (MoMo) or ₦ (UBA). After checkout, upload your payment screenshot on the form. Your receipt is saved in the admin portal. JauraStore will confirm your payment. Transport fare is discussed on WhatsApp.",
  ...
  const fr = {
    ...
    "ck.payIntro": "Payez d’abord sur le compte ci-dessous. Téléchargez le reçu bancaire et indiquez votre n° de commande. Les frais de transport seront discutés avec vous sur WhatsApp. Votre reçu est enregistré dans le portail admin. JauraStore confirmera votre paiement.",
    ...
    "ck.emailNote": "Votre reçu est enregistré dans le portail admin. JauraStore confirmera votre paiement.",
