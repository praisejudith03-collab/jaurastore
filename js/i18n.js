...
window.I18N = (() => {
  ...
  const en = {
    ...
    "account.forgotLead": "We will email a reset link if this address has an account.",
    "account.sendReset": "Send reset link",
    "account.forgotSent": "If that address is registered, a reset link has been sent.",
    "account.reset": "Choose a new password",
    "account.resetLead": "This link works once and expires in one hour.",
    ...
    "account.claim": "Attach guest orders",
    "account.claimLead": "Orders you placed as a guest stay unlinked until you confirm a link we email you.",
    "account.claimSent": "If this email has guest orders, a confirmation link has been sent.",
    ...
    "account.badReset": "That reset link is invalid or has expired.",
  ...
  const fr = {
    ...
    "account.forgotLead": "Nous enverrons un lien de réinitialisation si cette adresse a un compte.",
    "account.sendReset": "Envoyer le lien",
    "account.forgotSent": "Si cette adresse est enregistrée, un lien a été envoyé.",
    "account.reset": "Nouveau mot de passe",
    "account.resetLead": "Ce lien ne fonctionne qu’une fois et expire dans une heure.",
    ...
    "account.claim": "Lier les commandes invitées",
    "account.claimLead": "Les commandes passées en invité restent non liées jusqu’à confirmation par e-mail.",
    "account.claimSent": "Si cet e-mail a des commandes invitées, un lien de confirmation a été envoyé.",
    ...
    "account.badReset": "Ce lien de réinitialisation est invalide ou a expiré.",
