...
const JA = (() => {
  ...
  function applySiteBranding(site) {
    try {
      if (site.logoUrl) {
        ...
        const LOGO = "images/brand/logo.jpg?v=140";
        const FLYER = "images/brand/logo-flyer.jpg?v=140";
        const cur = settings();
    ...
    <header class="header" data-header>
      ...
      <div class="wrap header-inner">
        <a class="logo" href="index.html">
          <img src="images/brand/logo.jpg?v=140" alt="Jaura" />
        </a>
        <nav class="nav-left">
    ...
    return `<footer class="footer au-footer">
      <div class="wrap foot-grid">
        <div class="foot-brand">
          <a class="logo foot-logo" href="index.html"><img src="images/brand/logo-flyer.jpg?v=140" alt="Jaura" /></a>
  ...
  function showWelcome() {
    ...
    el.innerHTML = `
      <div class="welcome-card">
        ...
        <img class="welcome-logo" src="images/brand/logo.jpg?v=140" alt="Jaura" />
  ...
  function absUrl(path) {
    if (!path) return SITE + "/images/brand/og-cover.jpg?v=140";
  ...
  function setSeo(opts = {}) {
    ...
    const image = absUrl(opts.image || "images/brand/og-cover.jpg?v=140");
