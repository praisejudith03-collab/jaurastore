  ...
  $("#admin-root").innerHTML = `
    <div class="adx-login">
      <div class="adx-login-card">
        <img class="adx-login-logo" src="images/brand/logo.jpg?v=140" alt="Jaura Store" />
  ...
  $("#admin-root").innerHTML = `
    <div class="adx">
      <aside class="adx-side">
        <div class="adx-brand"><img src="images/brand/logo.jpg?v=140" alt="" /><div><strong>Jaura Store</strong><span>Store manager</span></div></div>
...
function bindCategories() {
  ...
  document.getElementById("add-cat")?.addEventListener("click", async () => {
    ...
    const next = collectCats().concat([{ id, name, nameFr, image: "images/brand/logo.jpg?v=140", hidden: false, order: collectCats().length }]);
